// Single language interface: Arabic is always used
var DEFAULT_LANGUAGE = 'ar';

function loadLanguage() {
    // The interface only supports Arabic, force it (ignore any saved value)
    user.currentLanguage = DEFAULT_LANGUAGE;
...
function applyLanguage(lang) {
    ...
    // Document Properties
    document.title = strings.pageTitle || projectName;
    document.dir = rtlLangs.includes(user.currentLanguage) ? 'rtl' : 'ltr';
    // The exploit log is always English, keep it LTR
    ui.consoleElement.dir = 'ltr';
