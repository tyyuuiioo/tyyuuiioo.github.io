window.lang = {
    ...
    "elfRequiresPayLoader": "This .elf payload can only be loaded through GoldHEN's PayLoader.\n\nEnable GoldHEN first, then click the payload again.",
    "payloadFileEmpty": "Payload file is empty or unreadable, so the exploit was not started",
    "elfLoaderMissing": "The ElfLoader file is not available (0 bytes) in this build. Use a .bin payload instead, or GoldHEN's PayLoader.",
    "layouts": "Layout",
